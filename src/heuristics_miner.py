...
print("Start Activities:", result["start_activities"])

print("End Activities:", result["end_activities"])

print("DFG Counts:", result["directly_follows_counts"])

print("Dependency Measures:", result["dependency_measures"])

print("Selected Edges:", result["selected_edges"])

print("Thresholds Used:", result["thresholds_used"])

save_model_summary(result, "heuristics_net_summary.json")
print("Saved summary to heuristics_net_summary.json")
